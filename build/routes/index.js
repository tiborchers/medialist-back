...
exports.default = function (app) {
  ...
  app.post('/api/movies/url', _passport2.default.authenticate('jwt', { session: false }), _movie2.default.createByUrl);
  ...
  app.post('/api/shorts/url', _passport2.default.authenticate('jwt', { session: false }), _short2.default.createByUrl);
  ...
  app.post('/api/documentaries/url', _passport2.default.authenticate('jwt', { session: false }), _documentary2.default.createByUrl);
  ...
  app.post('/api/videogames/url', _passport2.default.authenticate('jwt', { session: false }), _videogame2.default.createByUrl);
  ...
  app.post('/api/books/url', _passport2.default.authenticate('jwt', { session: false }), _book2.default.createByUrl);
  ...
  app.post('/api/albums/url', _passport2.default.authenticate('jwt', { session: false }), _album2.default.createByUrl);
  ...
  app.get('/api/user/movies/sum', _passport2.default.authenticate('jwt', { session: false }), _movie2.default.getMoviesSum);

  ...
  _createClass(Shorts, null, [{
    ...
    value: function modify(req, res) {
      ...
      return Short.findByPk(req.params.shortId).then(function () {
        var _ref15 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(short) {
          var gm;
    ...
    value: function watched(req, res) {
      ...
      return req.user.then(function (user) {
        Short.findByPk(req.params.shortId).then(function () {
          var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(short) {
            var gm;
    ...
    value: function watchedDate(req, res) {
      ...
      return req.user.then(function (user) {
        Short.findByPk(req.params.shortId).then(function () {
          var _ref17 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(short) {
            var gm;
    ...
    value: function unwatched(req, res) {
      ...
      return req.user.then(function (user) {
        Short.findByPk(req.params.shortId).then(function () {
          var _ref18 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(short) {
            var gm;
    ...
    value: function changeGenres(req, res) {
      ...
      Short.findByPk(req.params.shortId).then(function () {
        var _ref19 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(short) {
          var GM, newGenres;

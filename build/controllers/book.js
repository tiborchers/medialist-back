  ...
  _createClass(Books, null, [{
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                ...
                _context4.next = 6;
                return execFile('python3', ['server/controllers/scripts/goodreads.py', url]);
    ...
    value: function () {
      var _ref15 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(req, res) {
        ...
        var url, result, success, _result, image, title, year, commentary, pages, author, rating, genres;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 3:
                ...
                success = false;
                _context6.next = 7;
                return _axios2.default.post('http://python-dot-jovial-branch-266213.appspot.com/goodreads', {
                  url: url
                }).then(function (res) {
                  result = res;
                  success = true;
              ...
              case 9:
                _result = result, image = _result.image, title = _result.title, year = _result.year, commentary = _result.commentary, pages = _result.pages, author = _result.author, rating = _result.rating, genres = _result.genres;
    ...
    value: function modify(req, res) {
      ...
      return Book.findByPk(req.params.bookId).then(function () {
        var _ref21 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(book) {
          var gm;
    ...
    value: function read(req, res) {
      ...
      return req.user.then(function (user) {
        Book.findByPk(req.params.movieId).then(function () {
          var _ref22 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(book) {
            var gm;
    ...
    value: function readDate(req, res) {
      ...
      return req.user.then(function (user) {
        Book.findByPk(req.params.movieId).then(function () {
          var _ref23 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(book) {
            var gm;
    ...
    value: function unread(req, res) {
      ...
      return req.user.then(function (user) {
        Book.findByPk(req.params.movieId).then(function () {
          var _ref24 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(book) {
            var gm;
    ...
    value: function changeGenres(req, res) {
      ...
      Book.findByPk(req.params.bookId).then(function () {
        var _ref25 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(book) {
          var GM, newGenres;

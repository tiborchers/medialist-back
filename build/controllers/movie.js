  ...
  _createClass(Movies, null, [{
    ...
    value: function modify(req, res) {
      ...
      return Movie.findByPk(req.params.movieId).then(function () {
        var _ref23 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(movie) {
          var gm;
    ...
    value: function watched(req, res) {
      ...
      return req.user.then(function (user) {
        Movie.findByPk(req.params.movieId).then(function () {
          var _ref24 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(movie) {
            var gm;
    ...
    value: function watchedDate(req, res) {
      ...
      return req.user.then(function (user) {
        Movie.findByPk(req.params.movieId).then(function () {
          var _ref25 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(movie) {
            var gm;
    ...
    value: function unwatched(req, res) {
      ...
      return req.user.then(function (user) {
        Movie.findByPk(req.params.movieId).then(function () {
          var _ref26 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(movie) {
            var gm;
    ...
    value: function changeGenres(req, res) {
      ...
      Movie.findByPk(req.params.movieId).then(function () {
        var _ref27 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(movie) {
          var GM, newGenres;

...
var Documentaries = function () {
  ...
  _createClass(Documentaries, null, [{
    ...
    value: function _delete(req, res) {
      return req.user.then(function (user) {
        return Documentary.findByPk(req.params.movieId).then(function (documentary) {
          if (!documentary) {
            return res.status(400).send({
              success: false,
              message: 'Documentary Not Found'
    ...
    value: function modify(req, res) {
      ...
      return Documentary.findByPk(req.params.documentaryId).then(function () {
        var _ref15 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(documentary) {
          var gm;
    ...
    value: function watched(req, res) {
      ...
      return req.user.then(function (user) {
        Documentary.findByPk(req.params.movieId).then(function () {
          var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(documentary) {
            var gm;
    ...
    value: function watchedDate(req, res) {
      ...
      return req.user.then(function (user) {
        Documentary.findByPk(req.params.movieId).then(function () {
          var _ref17 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(documentary) {
            var gm;
    ...
    value: function unwatched(req, res) {
      ...
      return req.user.then(function (user) {
        Documentary.findByPk(req.params.movieId).then(function () {
          var _ref18 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(documentary) {
            var gm;
    ...
    value: function changeGenres(req, res) {
      ...
      Documentary.findByPk(req.params.documentaryId).then(function () {
        var _ref19 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(documentary) {
          var GM, newGenres;
